...
//    }
    ...
    public String cal(Model model){
        List<ClubScnu> titlename = clubRepository.findAll();
        log.info("title는 ={}",titlename);
        List<ClubScnu> startdate = clubRepository.findAll();
        List<ClubScnu> finaldate = clubRepository.findAll();
        model.addAttribute("titles",titlename);
        return "/scnu/board/cal";
    }
